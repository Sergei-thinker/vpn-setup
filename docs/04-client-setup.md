...
## Layer 1: Relay через российский VPS
...
## Layer 2: WebRTC OlcRTC (аварийный канал)
...
Layer 2 через WebRTC невозможен на мобильных устройствах:
- Нет клиента OlcRTC для iOS/Android
- iOS не поддерживает произвольный WebRTC DataChannel tunneling
- **Для мобильных устройств Layer 1 (relay) — последний рубеж защиты**
