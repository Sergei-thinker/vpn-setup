...
|-----------|-----------|------|-------------|
| **Windows** | **[v2rayN](https://github.com/2dust/v2rayN)** (рекомендуемый) | Бесплатно | [GitHub](https://github.com/2dust/v2rayN/releases) |
| Windows | [Hiddify](https://hiddify.com/) (альтернатива) | Бесплатно | GitHub / hiddify.com |
| Android | [v2rayNG](https://github.com/2dust/v2rayNG) / [Hiddify](https://hiddify.com/) | Бесплатно | Google Play / GitHub |
| **iOS** | **[Shadowrocket](https://apps.apple.com/app/shadowrocket/id932747118)** (рекомендуемый) | $2.99 | App Store |
...
> **Почему v2rayN лучше на Windows?** v2rayN поддерживает стабильный TUN-режим с sing-box core, встроенный пресет маршрутизации для России, и корректно обрабатывает QUIC/UDP трафик. Hiddify в TUN-режиме нестабилен ("failed to start background core"), а в режиме системного прокси утекает QUIC.

> **Почему Shadowrocket лучше на iOS?** Shadowrocket поддерживает WebSocket-транспорт, split routing и auto-select серверов.
