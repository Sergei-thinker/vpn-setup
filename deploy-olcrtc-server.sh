#!/bin/bash
# =============================================================================
#  DEPLOY-OLCRTC-SERVER — Установка OlcRTC сервера (Layer 3: WebRTC аварийный)
# =============================================================================
#
...
#    - Это аварийный канал — используйте ТОЛЬКО когда Layer 0-2 не работают
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Устанавливает OlcRTC сервер для аварийного WebRTC-канала (Layer 3)."
...
separator
echo -e "${BOLD}  OlcRTC Server — Layer 3 (Аварийный WebRTC через Телемост)${NC}"
separator
echo ""
...
# НЕ включаем автозапуск — Layer 3 активируется вручную
...
echo ""
warn "Layer 3 — АВАРИЙНЫЙ канал. Используйте только если Layer 0-2 не работают!"
separator
